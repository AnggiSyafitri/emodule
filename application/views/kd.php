<script type="text/javascript">
  ...
  function adminDetail(elm){
    ...
    var data = tablekompetensiDasar99.row(tr).data()
    openModal({
  ...
  function action_kompetensiDasar99(elm){
    /*<?=$kodetable?>.search( "" ).draw();
      ...
      openModal({
      title:((!elm) ? 'Tambah ':'Perbarui ')+" Data Kompetensi",
      ...
      footer:((!elm) ? '<button type="button" id="btnSave" onclick="savekompetensiDasar99()" class="btn btn-primary">Save</button> ':'<button onclick="savekompetensiDasar99(this)"  type="button" class="btn btn-warning">Update</button> ')+`
  ...
  function columnkompetensiDasar99(){
    var c = columndefaultkompetensiDasar99();
    c.push({ 
...
<div class="container-fluid px-4">
                        <h1 class="mt-4">Kompetensi Dasar</h1>
                ...
                "kode"=>"kompetensiDasar99",
                "dataapi"=>"admin/api/get/kd",
                "urladd"=>"admin/api/add/kd",
                "urlupdate"=>"admin/api/update/kd",
                "urldelete"=>"admin/api/delete/kd",
                "table_head"=>array(
                "No.",
                "Nama Kompetensi",
                "#",
